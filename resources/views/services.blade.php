@extends('layout')
@section('title', 'Services | Sheila Muwanga MC')
@section('content')
<section class="services py-20 bg-gradient-to-b from-purple-50 to-white">
    <div class="container mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
            ...
            <div class="service-card opacity-0 p-6 sm:p-8 bg-white rounded-2xl shadow-lg transform transition duration-700 hover:scale-105 hover:shadow-2xl">
                <div class="mb-4 text-purple-600 text-5xl">
                    <i class="fas fa-heart"></i>
                </div>
                <h3 class="text-xl sm:text-2xl font-semibold text-gray-800">Weddings</h3>
            </div>
            ...
            <div class="service-card opacity-0 p-6 sm:p-8 bg-white rounded-2xl shadow-lg transform transition duration-700 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 class="text-xl sm:text-2xl font-semibold text-gray-800">Corporate Events</h3>
            </div>
            ...
            <div class="service-card opacity-0 p-6 sm:p-8 bg-white rounded-2xl shadow-lg transform transition duration-700 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 class="text-xl sm:text-2xl font-semibold text-gray-800">Parties</h3>
            </div>
            ...
            <div class="service-card opacity-0 p-6 sm:p-8 bg-white rounded-2xl shadow-lg transform transition duration-700 hover:scale-105 hover:shadow-2xl">
                ...
                <h3 class="text-xl sm:text-2xl font-semibold text-gray-800">Conferences</h3>
            </div>
        </div>
    </div>
</section>
