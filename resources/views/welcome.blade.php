...
<body>
    ...
    <div class="flex items-center justify-center w-full transition-opacity opacity-100 duration-750 lg:grow starting:opacity-0">
        <main class="flex flex-col-reverse w-full max-w-full sm:max-w-sm md:max-w-md lg:max-w-4xl lg:flex-row mx-auto p-4 lg:p-6">

            <!-- Left content -->
            <section class="flex-1 flex flex-col justify-center gap-4 lg:gap-6">
                <h1 class="text-3xl sm:text-4xl font-bold text-black">
                    Welcome to Our Platform
                </h1>
                <p class="text-sm sm:text-base text-gray-700">
                    Explore features and enjoy a smooth experience across any device—desktop, tablet, or mobile.
                </p>

                <ul class="flex flex-col gap-3 mt-4">
                    <li class="flex items-center gap-3 py-3 px-2 rounded hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-200 cursor-pointer">
                ...
                <div class="mt-4 flex flex-col sm:flex-row gap-3">
                    <a href="#get-started" class="px-5 py-3 bg-red-500 text-white rounded text-center text-sm sm:text-base hover:bg-red-600 focus:bg-red-600 active:bg-red-700 transition">
                        Get Started
                    </a>
                    <a href="#learn-more" class="px-5 py-3 border border-gray-400 rounded text-center text-sm sm:text-base hover:bg-gray-100 focus:bg-gray-100 active:bg-gray-200 transition">
                        Learn More
                    </a>
                </div>
            </section>
            ...
            <section class="flex-1 flex justify-center items-center mb-6 lg:mb-0">
                <svg class="w-full h-auto max-w-[90%] mx-auto" viewBox="0 0 438 104" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M..." fill="#F53003" />
                    <path d="M..." fill="#000" />
                </svg>
            </section>
